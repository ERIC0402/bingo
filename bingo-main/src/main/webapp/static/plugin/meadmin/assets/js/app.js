var App = function() {
    ...
    var v = function() {
        ...
        $(".navbar li.nav-toggle").unbind("click");
        ...
        $(".toggle-top-left-menu").unbind("click");
    ...
    var d = function() {
        ...
        $("#sidebar-content ul > li > a").unbind("click");
    ...
    var e = function() {
        ...
        if ($.cookie) {
        	$("#theme-switcher label").unbind("click");
    ...
    var i = function() {
    	$(".widget .toolbar .widget-collapse").unbind("click");
    ...
    var k = function() {
        ...
        $(".table-checkable tbody tr td.checkbox-column :checkbox").unbind("click");
        $(".table-checkable tbody tr td.checkbox-column :checkbox").on("click", function(e) {
            e.stopPropagation();
        });
        
        $(".table-checkable tbody tr").unbind("click");
        $(".table-checkable tbody tr").on("click", function() {
        	var ck = $(this).find(".checkbox-column :checkbox");
        	if(ck) {
        		var z = !ck.prop("checked");
            	ck.prop("checked", z).trigger("change");
            	$.uniform.update(ck);
        	}
        });
    ...
    var p = function() {
        c();
        $(".project-switcher-btn").unbind("click");
