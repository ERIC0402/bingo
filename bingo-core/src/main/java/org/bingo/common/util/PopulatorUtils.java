...
public class PopulatorUtils {
	...
	protected static final Logger logger = LoggerFactory.getLogger(PopulatorUtils.class);

	public static final boolean TRIM_STR = true;

	private static final SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

	private static BeanUtilsBean beanUtils = new BeanUtilsBean(Converter.getDefault());
	 ...
	 * @return 初始化完成对象及其类型
	 */
	public static Object initProperty(final Object target, String entityName, final String attr) {
	 ...
	 * @param value
	 */
	public static void populateValue(final Object target, String entityName, final String attr, Object value) {
		try {
			if (attr.indexOf('.') > -1) {
	...
	public static void populateValue(Object target, String attr, Object value) {
		populateValue(target, target.getClass().getName(), attr, value);
	}

	public static Object populate(Object target, Map<String, Object> params) {
		return populate(target, target.getClass().getName(), params);
	}

	public static Object populate(String entityName, Map<String, Object> params) {
		try {
	...
	public static Object populate(Class<?> entityClass, Map<String, Object> params) {
		try {
	 ...
	 * @param entity
	 */
	public static Object populate(Object entity, String entityName, Map<String, Object> params) {
	...
	private static void setValue(final String attr, final Object value, final Object target) {
		try {
			beanUtils.copyProperty(target, attr, value);
		} catch (Exception e) {
